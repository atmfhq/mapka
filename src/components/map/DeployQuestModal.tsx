...
import { CalendarIcon, Compass, Clock, MapPin, AlertTriangle } from 'lucide-react';
...
const DeployQuestModal = ({ 
  ...
  const handleSubmit = async () => {
    ...
    // Note: share_code is auto-generated by database trigger
    const insertData = {
      title,
      description: description.trim() || null,
      category: selectedIcon, // Store the emoji as the category
