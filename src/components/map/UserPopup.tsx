...
const UserPopup = ({ user, position, onClose }: UserPopupProps) => {
  return (
    <div 
    ...
    >
      <div className="relative bg-card/95 backdrop-blur-md border border-primary/30 rounded-lg p-4 min-w-[200px] max-w-[280px] shadow-[0_0_20px_hsl(var(--primary)/0.3)]">
        {/* Arrow */}
