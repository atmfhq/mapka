      ...
      <DialogContent className="sm:max-w-md bg-card/95 backdrop-blur-md border-2 border-border">
        ...
        {magicLinkSent ? (
          ...
          <div className="text-center space-y-4 pt-2">
            <div className="w-16 h-16 mx-auto rounded-2xl bg-success/20 border-2 border-success/40 flex items-center justify-center">
          ...
          <div className="space-y-4 pt-2">
            ...
            <Button
              type="button"
              variant="outline"
              className="w-full h-12 gap-3 font-nunito font-bold"
